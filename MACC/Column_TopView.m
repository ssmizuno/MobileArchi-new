...
//  MobileArchi
//
//  Created by 水野 真史 on 12/01/30.
//  Copyright (c) 2012 __MyCompanyName__. All rights reserved.
//

#import "Column_TopView.h"
#import "ColumnCell.h"


@implementation Column_TopView
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (cell == nil) {
        ...
        cell.cellLabel.text = [NSString stringWithFormat:@"1-%d番目の記事(ニュース)", indexPath.row+1];
    }
